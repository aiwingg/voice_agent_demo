...
// Serve static files from the React app under /demo path
// This ensures all static assets (js, css, images) are served from /demo
app.use('/demo', express.static(path.join(__dirname, 'client/build'), {
  // This ensures the URL in the browser stays as /demo
  index: false
}));

// Serve index.html for /demo path
app.get('/demo', (req, res) => {
  res.sendFile(path.join(__dirname, 'client/build', 'index.html'));
});

// Serve index.html for all other /demo/* paths
app.get('/demo/*', (req, res) => {
  res.sendFile(path.join(__dirname, 'client/build', 'index.html'));
});
